function [windbin, areas] = findwind

for t = 1:size(dir('resizedRGB/*.jpg'))
    input_img = strcat('resizedRGB/','resizedRGB-00',int2str(t),'.jpg');
    ...
    edges = imdilate(edges,strel('rectangle',[2 2]));
